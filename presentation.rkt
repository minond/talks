...
(slide
  #:title "What are we talking about and why are we talking about it?"
  (p #<<P
We're going to be talking about programming languages. More specifically, we're
going to be talking about interpreters. And even more specifically than that,
we're going to talk about how you take a sequence of characters that only a
human could understand and make a computer do something.
P
))
